...
const Footer = () => {
    return (
        <>
            <div className=" px-4 md:px-10 z-50! relative  h-full w-full flex flex-col items-center justify-center pt-10 pb-24 bg-[#0A3255]">
                <div className="max-w-7xl w-full h-full flex  items-center pb-2">
                    <div className="w-full py-2 flex  gap-3  h-full justify-between items-center text-white ">
                ...
                <div className=" max-w-7xl w-full h-full flex justify-between items-center lg:border-t lg:border-[#FFF] ">

                    <div className="border-t border-[#FFF] py-2 h-full items-center lg:border-0">
                    ...
                    <div className="py-2  flex  gap-3  h-full justify-center items-center text-[#FFF]">
                        ...
                        <div className="w-full flex  divide-x divide-[#FFF] justify-center lg:justify-start gap-3  border-[#FFF]   ">
                            ...
                            <p className=" text-sm cursor-pointer pl-3  ">
                                Disclaimer
                            </p>
